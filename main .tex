...
\usepackage{graphicx\documentclass[12pt, a4paper]{article}
...
\textbf{Data \& Code:} \url{https://github.com/IngvarO1/voynich-structural-study} \\
...
All statistical tests were performed with Python 3.9 using SciPy 1.7.3. Multiple comparison corrections were applied where appropriate. Specifically, χ²-tests were performed using scipy.stats.chi2\_contingency with Yates' correction for small expected frequencies where appropriate.
...
\toprule
\textbf{Section} & \textbf{Words} & \textbf{Characters} & \textbf{'i' frequency} & \textbf{'i' mid-word} & \textbf{Patterns} \\
\midrule
...
\begin{tabular}{lrrrrr}
\toprule
\textbf{Section} & \textbf{...iin ($\oplus_n$)} & \textbf{...iir ($\oplus_r$)} & \textbf{...iiy ($\oplus_y$)} & \textbf{...iil ($\oplus_l$)} & \textbf{Total} \\
\midrule
...
\begin{itemize}
    ...
    \end{itemize}
    \item $\mathcal{O} = \{n, r, y, l\}$ -- operators
    \item $V = \{a, o, e\}$ -- vowel links
    \item $i$ -- quasi-neutral element
    \item $\oplus: P \times \mathcal{O} \rightarrow W$ -- application of operator to base vector, producing a word $w \in W$
\end{itemize}
...
\begin{itemize}
    ...
    \item $\oplus_l$ (...iil): Cycle/completion/boundary
\end{itemize}
...
\url{https://github.com/IngvarO1/voynich-structural-study}
...
\begin{itemize}
    ...
    \item \textbf{GitHub:} \url{https://github.com/IngvarO1}
    \item \textbf{Repository:} \url{https://github.com/IngvarO1/voynich-structural-study}
\end{itemize}
